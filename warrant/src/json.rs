...
//!
//! Warrant ships no third-party crates: it sits on the authorization path, and
//! a dependency there is a dependency you have to trust with everything it
//! guards. This module is the price of that, and it is a small one.
